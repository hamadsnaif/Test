...
const BUILD = '3cc60b9d3edc';
const CACHE = 'hamads-games';
const ASSETS = ["./", "./apple-touch-icon.png", "./bounce.html", "./cadet.html", "./games.json", "./icon-120.png", "./icon-152.png", "./icon-167.png", "./icon-180.png", "./icon-192.png", "./index.html", "./manifest.webmanifest", "./pinball-sky.jpg", "./pinball.html", "./snake.html", "./tetris.html"];
