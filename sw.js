...
const BUILD = 'e541eedb3acf';
const CACHE = 'hamads-games';
const ASSETS = ["./", "./apple-touch-icon.png", "./bounce.html", "./cadet.html", "./frozen.html", "./games.json", "./icon-120.png", "./icon-152.png", "./icon-167.png", "./icon-180.png", "./icon-192.png", "./index.html", "./manifest.webmanifest", "./shadda.html", "./snake.html", "./tetris.html"];
